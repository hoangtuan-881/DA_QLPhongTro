...
import { availableRooms } from '../available-rooms/page';
import type { Room } from '../available-rooms/page'; // type-only import để tránh lỗi verbatimModuleSyntax
            ...
            {visibleRooms.map((room) => (
              <div key={room.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div className="relative h-48 bg-gray-200">
                  {room.images?.length ? (
                    <img src={room.images[0]} alt={`Phòng ${room.number} - ${room.building}`} className="w-full h-full object-cover" />
                  ) : (
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="bg-black/60 text-white px-2 py-1 rounded text-xs">{room.images?.length || 0} ảnh</span>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center text-sm text-gray-600">
                      <i className="ri-ruler-line mr-2"></i>Diện tích: {room.area}m²
                    </div>
                    <div className="flex items-center text-sm text-gray-600">
                      <i className="ri-money-dollar-circle-line mr-2"></i>Cọc: {formatPrice(room.deposit)} VNĐ
                    </div>
                    <div className="flex items-center text-sm text-gray-600">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      {selectedRoom.nearbyFacilities.map((f, i) => (
              ...
              <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                ...
                <button
                  onClick={() => {
                    ...
                    if (selectedRoom) handleDeposit(selectedRoom);
                  }}

  ...
  */
  ...
  const handleDeleteRequest = (requestId: number) => {
    ...
    setConfirmDialog({
      ...
      message: `Bạn có chắc chắn muốn xóa yêu cầu "${request.title}" không? Hành động này không thể hoàn tác.`,
      type: 'danger',
      onConfirm: () => {
        setRequests(requests.filter(r => r.id !== requestId));
        success({ title: `Đã xóa yêu cầu "${request.title}" thành công!` });
        setConfirmDialog({ ...confirmDialog, isOpen: false });
      }
    });
  };
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-gray-600 mt-1">Quản lý yêu cầu bảo trì và sửa chữa</p>
              </div>
              <button
                    ...
                    <div className="space-y-2">
                      ...
                      {selectedRequest.completedDate && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{selectedRequest.completedDate}</span>
                        </div>
                      )}
                    ...
                    <div className="space-y-2">
                      {selectedRequest.estimatedCost && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium text-orange-600">{selectedRequest.estimatedCost} VNĐ</span>
                        </div>
                      )}
                      {selectedRequest.actualCost && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Chi phí thực tế:</span>
                          <span className="font-medium text-green-600">{selectedRequest.actualCost} VNĐ</span>
                        </div>
                      )}
                    </div>
                  </div>

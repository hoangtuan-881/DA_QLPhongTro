              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-green-600">{formatPrice(selectedRoom.price)} VNĐ/tháng</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Tiền cọc:</span>
                        <span className="font-medium text-orange-600">{formatPrice(selectedRoom.deposit)} VNĐ</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      {selectedRoom.nearbyFacilities.map((facility: string, index: number) => (
                        <div key={index} className="flex items-center text-sm text-gray-700">
              ...
              <form onSubmit={handleSubmitDeposit} className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-gray-600">Giá thuê:</span>
                      <span className="font-medium text-green-600">{formatPrice(selectedRoom.price)} VNĐ</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Tiền cọc:</span>
                      <span className="font-medium text-orange-600">{formatPrice(selectedRoom.deposit)} VNĐ</span>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-amber-700 space-y-1">
                        ...
                        <li>• Sau khi đặt cọc, bạn có 3 ngày để hoàn tất thủ tục ký hợp đồng</li>
                        <li>• Nếu không ký hợp đồng trong thời hạn, tiền cọc sẽ không được hoàn trả</li>
